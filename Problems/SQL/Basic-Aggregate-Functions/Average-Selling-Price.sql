...
| price         | int     |
+---------------+---------+
(product_id, start_date, end_date) is the primary key (combination 
...
means there will be no two intersecting periods for the same 
product_id.
...
Each row of this table indicates the date, units, and product_id
...
If a product does not have any sold units, its average selling 
